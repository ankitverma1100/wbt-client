        ...
        <div
          ...
          <div className="custom-modal-text modal-body">
            ...
            <p>
              ...
              'Antpro.in' से लॉगिन करें। लॉगइन करने से पहले साइट का नाम जरूर देख
              लें। आपके समर्थन के लिए धन्यवाद। टीम antpro
            </p>
            <h2>Dear Client,</h2>
            <p>
              We don't have any duplicate site , You are requested to login with
              our official site Antpro.in. I only. Please check the site name
              before you login. Thanks for your support. Team antpro
            </p>
          </div>
