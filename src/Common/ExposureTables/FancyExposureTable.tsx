...
const FancyExposureTable = ({ items }: Props) => {
        ...
        >
          <thead>
            <tr style={{ background: "#0B6CCF", color: "#fff" }}>
              ...
              <th style={{ border: "1px solid #000" }}>MATCH</th>
              ...
              <th style={{ border: "1px solid #000" }}>MODE</th>
          ...
          <tbody style={{ background: "#79B9FF" }}>
            ...
            return (
              <tr key={`${match}-${runner}-${index}`}>
                ...
                <td style={{ border: "1px solid #fff" }}>{match}</td>
                ...
                <td style={{ border: "1px solid #fff" }}>{mode}</td>
...
export default FancyExposureTable;
